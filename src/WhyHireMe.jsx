        ...
        >
          <div className="flex2">
            <div className="box">
              ...
              <p className="main_text_why">IT Graduate</p>
            </div>
            <div className="box">
        ...
        >
          <div className="flex2">
            <div className="box">
              ...
              <h4 className="mid_text">4★</h4>
              <p className="main_text_why">Code Quality</p>
            </div>
            <div className="box ">
              <img src={experience} alt="" className="why_logo" />
              <h4 className="mid_text">2+</h4>
              <p className="main_text_why">Years of Experience</p>
            </div>
          </div>
        </motion.div>
      </div>
