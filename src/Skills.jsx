  ...
  return (
    ...
    >
      ...
      <div className="contents">
        <div className="flex">
          <SemiDonutChart percentage={90} fill="#03B0FD" txt="HTML" />
          <SemiDonutChart percentage={87} fill="#03B0FD" txt="CSS" />
          <SemiDonutChart percentage={70} fill="#03B0FD" txt="JavaScript" />
        </div>
        <div className="flex">
          <SemiDonutChart percentage={60} fill="#03B0FD" txt="React" />
          <SemiDonutChart percentage={99} fill="#03B0FD" txt="C" />
